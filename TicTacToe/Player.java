...
public class Player {
  ...
  public Player(String name, String symbol, Game game) {
    this.name = name;
    this.symbol = symbol;
    this.m_game = game;
  ...
  public int[] getMove() {
    ...
    // 2. Return an array of two integers, the first being the row number and the second being the column number
    // 3. If the user enters an invalid row or column number, ask them to enter a valid one
    System.out.print("\"" + name + "\", Enter a row number and collum number: ");
