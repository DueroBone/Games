...
public class PropertySetGenerator {
    public static final PropertyBase[] createDefault() {
        ...
        PropertyBase[] properties = new PropertyBase[] {
                ...
                new StreetProperty("States", StreetColor.Pink,
                        140, new int[] { 10, 50, 150, 450, 625, 750 }),
                new StreetProperty("Virginia", StreetColor.Pink,
                ...
                new DrawProperty("Community Chest", communityChestDeck),
                new StreetProperty("Tennessee", StreetColor.Orange,
                        180, new int[] { 14, 70, 200, 550, 750, 950 }),
                new StreetProperty("New York", StreetColor.Orange,
                        200, new int[] { 16, 80, 220, 600, 800, 1000 }),

                new DrawProperty("Free Parking", freeParking),
                new StreetProperty("Kentucky", StreetColor.Red,
                        220, new int[] { 18, 90, 250, 700, 875, 1050 }),
                new DrawProperty("Chance", chanceDeck),
                new StreetProperty("Indiana", StreetColor.Red,
                        220, new int[] { 18, 90, 250, 700, 875, 1050 }),
                new StreetProperty("Illinois", StreetColor.Red,
                        240, new int[] { 20, 100, 300, 750, 925, 1100 }),
                new RailroadProperty("B&O RR"),
                new StreetProperty("Atlantic", StreetColor.Yellow,
                        260, new int[] { 22, 110, 330, 800, 975, 1150 }),
                new StreetProperty("Ventnor", StreetColor.Yellow,
                        260, new int[] { 22, 110, 330, 800, 975, 1150 }),
                ...
                new StreetProperty("Pacific", StreetColor.Green,
                        300, new int[] { 26, 130, 390, 900, 1100, 1275 }),
                new StreetProperty("North Carolina", StreetColor.Green,
                        300, new int[] { 26, 130, 390, 900, 1100, 1275 }),
                new DrawProperty("Community Chest", communityChestDeck),
                new StreetProperty("Pennsylvania", StreetColor.Green,
